...
(function() {
  ...
  async function checkPremiumStatus() {
    try {
      ...
      console.log('[しらべる君 テラピーク] プレミアム状態:', isPremiumUser);
      return isPremiumUser;
    } catch (error) {
      console.error('[しらべる君 テラピーク] プレミアムチェックエラー:', error);
      return false;
    }
  }
  ...
  function showPremiumPrompt() {
    ...
    panel.innerHTML = `
      ...
      ">
        ...
        <div style="padding: 20px; text-align: center;">
          ...
          <button id="kuraberu-tp-go-settings" style="
            width: 100%;
            padding: 12px;
            background: linear-gradient(135deg, #f5af02 0%, #e09b00 100%);
            color: white;
    ...
    document.getElementById('kuraberu-tp-go-settings').addEventListener('click', () => {
